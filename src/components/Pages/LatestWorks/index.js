...
const LatestWorks = () => {
          ...
          <a style={{color: "rgb(63, 23, 63)"}} href="https://gentle-citadel-53498.herokuapp.com/ " target="_blank" rel="noreferrer">Eight Ball: React</a><span>&nbsp;|&nbsp;</span><a style={{color: "rgb(63, 23, 63)"}} href="https://github.com/Allyse500/eight_ball " target="_blank" rel="noreferrer">GitHub</a><br/>
        </div>
          </div>
          );
        }
